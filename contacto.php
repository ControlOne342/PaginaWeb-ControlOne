            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-bold text-primary mb-6">Atención Inmediata</h3>
                        ...
                        <h4 class="text-sm font-bold text-gray-500 uppercase mb-4">Datos de Oficina</h4>
                        <ul class="space-y-4 text-gray-600">
                            ...
                            <li class="flex items-center">
                                ...
                                <a href="tel:+525558642200" class="hover:text-primary transition-colors ml-2 font-semibold">+52 55 5864 2200</a>
                            </li>
                            ...
                            <li class="flex items-center">
                                ...
                                <a href="mailto:socialmedia@controlone.com.mx" class="hover:text-primary transition-colors ml-2">socialmedia@controlone.com.mx</a>
                            </li>
                        </ul>
                    </div>
